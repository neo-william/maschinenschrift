...
Die Seite wird statisch auf Cloudflare Pages ausgeliefert, betrieben
durch Cloudflare, Inc. (101 Townsend Street, San Francisco, CA 94107,
USA). Beim Aufruf einer Seite verarbeitet Cloudflare die IP-Adresse,
die angefragte URL, die HTTP-Methode sowie die Header User-Agent und
Referer, um den Inhalt auszuliefern und vor Missbrauch zu schützen.
Cloudflare setzt für die Auslieferung dieser Seite keine Cookies; es
findet kein Tracking statt.

Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO — berechtigtes Interesse an
stabiler, verfügbarer und missbrauchsgeschützter Inhalts-Bereitstellung.
Speicherdauer: Cloudflare aggregiert Anfragedaten; einzelne Log-Einträge
werden zur Sicherheits-Analyse vorgehalten und anschließend gelöscht.
Einzelheiten in der
[Cloudflare-Datenschutzerklärung](https://www.cloudflare.com/privacypolicy/).

Drittlandtransfer: Cloudflare, Inc. hat ihren Sitz in den USA. Der
Transfer stützt sich auf die EU-Standardvertragsklauseln sowie auf die
...
Mails an `contact [at] maschinenschrift [dot] com` werden vom Mail-Anbieter
Mailbox.org (Heinlein Support GmbH, Berlin) entgegengenommen und dort
in einem Postfach des Verantwortlichen gespeichert. Mailbox.org sitzt in
Deutschland — kein Drittlandtransfer. Ein Auftragsverarbeitungsvertrag
nach Art. 28 DSGVO liegt vor. Inhalte werden manuell verarbeitet; eine
automatisierte Speicherung in einer Datenbank findet nicht statt.
