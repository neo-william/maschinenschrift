...
description: "Article 50 of the EU AI Act has applied since 2 August 2026. It requires labelling for deep fakes and for text of public interest. Of the novel it requires nothing."
seotitle: "What the Law Does Not Require — The EU AI Act, Article 50, and AI Labelling for Books"
...
sources:
  - title: "Regulation (EU) 2024/1689 (AI Act), Article 50 — Transparency obligations for providers and deployers of certain AI systems"
    ...
    note: "Official Journal L, 12.7.2024. Article 50 applies from 2 August 2026 (Article 113). Cited here: paragraph 2 (machine-readable marking by providers) and paragraph 4 (disclosure by deployers, the exception for evidently artistic works, and the separate sub-paragraph on text published to inform the public on matters of public interest)."
  - title: "Guidelines on transparency obligations for providers and deployers of certain AI systems"
    ...
    note: "Interpretive guidelines on Article 50, published days before the date of application. The exception for artistic works is read narrowly: where informative and creative character are mixed, the informative character prevails."
  - title: "Updates to AI labeling requirements (July 2026)"
    ...
    note: "Google permits text and visual labels inside AI-generated ad creatives and supplies a setting for self-labelling. The policy states that the setting does not guarantee compliance with any regulation; the obligation stays with the advertiser. A mandatory checkbox exists only for election ads."
  - title: "Google introduces new AI labels for Ads"
    ...
    note: "Announcement of the “How this ad was made” panel in My Ad Center across Search, YouTube, and Discover. Ads made with Google's own generative tools are labelled automatically; everything else runs through a voluntary control."
---
...
On the form in which the account is given: [Idea](/idea/). On the axes and their notation: [Siegel-Spec v7](/spec/siegel-v7/).
