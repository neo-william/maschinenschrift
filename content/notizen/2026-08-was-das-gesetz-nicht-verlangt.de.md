---
title: "Was das Gesetz nicht verlangt"
description: "Seit dem 2. August 2026 gilt Artikel 50 des EU AI Act. Er verlangt Kennzeichnung für Deepfakes und öffentliche Information. Vom Roman verlangt er nichts."
seotitle: "Was das Gesetz nicht verlangt — EU AI Act, Artikel 50 und die KI-Kennzeichnung von Büchern"
date: 2026-08-03T01:00:00+02:00
...
sources:
  - title: "Verordnung (EU) 2024/1689 (KI-Verordnung), Artikel 50 — Transparenzpflichten für Anbieter und Betreiber bestimmter KI-Systeme"
    ...
    note: "Amtsblatt L, 12.7.2024. Artikel 50 gilt seit dem 2. August 2026 (Artikel 113). Zitiert werden Absatz 2 (maschinenlesbare Markierung durch die Anbieter) und Absatz 4 (Offenlegung durch die Betreiber, Ausnahme für offenkundig künstlerische Werke, gesonderter Absatz für Text von öffentlichem Interesse)."
  - title: "Guidelines on transparency obligations for providers and deployers of certain AI systems"
    ...
    note: "Auslegungsleitlinien zu Artikel 50, veröffentlicht wenige Tage vor Geltungsbeginn. Die Ausnahme für künstlerische Werke wird eng gelesen: mischen sich informierender und künstlerischer Charakter, überwiegt der informierende."
  - title: "Updates to AI labeling requirements (July 2026)"
    author: "Google Advertising Policies Help"
    date: 2026-07-09
    type: policy
    url: https://support.google.com/adspolicy/answer/17257106
    note: "Google erlaubt Text- und Bildlabel in KI-erzeugten Anzeigenmotiven und stellt eine Einstellung zur Selbstkennzeichnung bereit. Die Einstellung garantiert ausdrücklich keine Rechtskonformität; die Pflicht bleibt bei der Werbetreibenden. Pflichtfeld nur für Wahlwerbung."
  - title: "Google introduces new AI labels for Ads"
    author: "Keerat Sharma, Google"
    date: 2026-07-09
    type: press
    url: https://blog.google/products/ads-commerce/google-ads-ai-transparency-labels/
    note: "Ankündigung des Felds „How this ad was made“ in My Ad Center für Search, YouTube und Discover. Anzeigen aus Googles eigenen generativen Werkzeugen werden automatisch gekennzeichnet, alles übrige über eine freiwillige Einstellung."
---
...
Der Rest ist Auskunft. Wer geschaltet hat, sagt, wie es entstanden ist. Das ist keine Nachlässigkeit, sondern die einzige Konstruktion, die trägt — die maschinelle Erkennung maschineller Texte ist an ihrem eigenen Anspruch gescheitert, und wer haftet, weiß es ohnehin besser als jeder Detektor. Der Nachweis dazu steht an anderer Stelle: [Die Hexenprobe](/de/notizen/2026-06-die-hexenprobe/).
...
Zur Form, in der die Auskunft gegeben wird: [Idee](/de/idee/). Zu den Achsen und ihrer Notation: [Siegel-Spec v7](/de/spec/siegel-v7/).
