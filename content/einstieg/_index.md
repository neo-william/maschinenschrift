...
The mark for your own work can be assembled here: [Seal](/seal/). The entered works are in the [Registry](/registry/), and admission runs by [email](/submit/). For the terms in more detail — why the project speaks of *mediation* rather than collaboration — the long version is under [Idea](/idea/); the running responses to incidents and texts are in the [Notes](/notes/).

---

## Sources

- Pangram Labs: [*AI is Writing Prize-Winning Fiction*](https://www.pangram.com/blog/ai-is-writing-prize-winning-fiction) — analysis of the Commonwealth winning stories, May 2026.
...
- Notes From Poland: [*Polish Nobel literature laureate Tokarczuk sparks controversy after admitting using AI*](https://notesfrompoland.com/2026/05/21/polish-nobel-literature-laureate-tokarczuk-sparks-controversy-after-admitting-using-ai/) — the Poznań quotes and the retraction statement.
- Snopes: [*Pope Leo AI encyclical*](https://www.snopes.com/news/2026/06/03/pope-leo-ai-encyclical/) — fact-check of the detector finding; verdict: unproven.
